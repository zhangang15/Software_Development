...
public class DirectoryParser {
	...
	/**
	 * This method getFileList is for return the fileList only including text
	 * files.
	 * 
	 * @param dir
	 *            directory
	...
	//
	/**
	 * This method getAllTxt use recursive way to add all text files into a
	 * list.
	 * 
	 * @param dir
	 *            directory contains text files and sub-directory.
	 * @param fileList
	 *            obtain all the text files in the directory.
	 */
